...
const VideoCard: React.FC<VideoCardTypes> = ({ thumbnail, title, channelIcon, channelName, views, timestamp }) => {
    return (
        <div className="mb-9 w-[16.5rem] cursor-pointer hover:scale-[1.2] duration-300 hover:shadow-lg bg-white">
            ...
            <div className="flex p-3">
                ...
                <div className="mx-2">
                    <p className="text-sm font-roboto font-medium mb-[0.125rem] w-[90%]">{title}</p>
